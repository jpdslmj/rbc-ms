        ...
        .bootstrapTable(
            {
                ...
                queryParams : function(params) {
                    return {
                        ...
                        assistValue:$('#assistValueNew').val(),
                ...
                columns : [
                    ...
                    },
                    {
                        ...
                        formatter : function(value, row, index) {
                            var e = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑1" onclick="edit3(\''
                                + row.id
...
function reLoad3() {
    $('#assistValveF8NewTable').bootstrapTable('refresh');
}
function add3() {
    layer.open({
        type : 2,
...
function batchRemove3() {
    var rows = $('#assistValveF8NewTable').bootstrapTable('getSelections'); // 返回所有选择的行，当没有选择的记录时，返回一个空数组
    if (rows.length == 0) {
        layer.msg("请选择要删除的数据");
        return;
    }
